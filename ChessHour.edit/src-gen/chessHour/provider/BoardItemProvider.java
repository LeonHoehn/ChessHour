...
/**
 * This is the item provider adapter for a {@link chessHour.Board} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BoardItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addWidthPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						ChessHourPackage.Literals.BOARD__WIDTH, true, false, false,
	...
	protected void addHeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						ChessHourPackage.Literals.BOARD__HEIGHT, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ChessHourPackage.Literals.BOARD__CELLS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case ChessHourPackage.BOARD__WIDTH:
		case ChessHourPackage.BOARD__HEIGHT:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case ChessHourPackage.BOARD__CELLS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(ChessHourPackage.Literals.BOARD__CELLS, ChessHourFactory.eINSTANCE.createCell()));
	}
